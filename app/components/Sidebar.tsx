...
const Sidebar = () => {
    ...
    return (
        <aside className={`${isSidebarOpen ? "translate-x-50" : "translate-x-0"} fixed md:relative md:translate-x-0 flex flex-col min-h-screen justify-between transition-all duration-300 z-40 overflow-y-auto bg-bg-light1 dark:bg-bg-dark2 dark:text-white/90 w-50 md:w-64  border border-text-light2/50 dark:border-text-light2/25 `}>
