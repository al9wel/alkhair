...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center h-16 justify-between fixed top-0 left-0 w-full md:w-[calc(100%-16rem)]   bg-light dark:bg-dark px-4 py-3 text-black/70 dark:text-light-text border-b border-border/50 dark:border-border/25">
